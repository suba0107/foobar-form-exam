...
export default function Mug(props) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 230 275">
      <g id="Layer_1" data-name="Layer 1">
        <g>
          <path className="mug-1" d="M3.4,2.52H176.64V263.09s-90.14,21.12-173.24,0Z" />
          <path
            id="Path_99"
            data-name="Path 99"
            className="mug-2"
          ...
          <image width="808" height="926" transform="translate(20.39 76.37) scale(0.17)" xlinkHref={`../images/${label}.png`} />
          ...
          <path className="mug-1" d="M159.38,65.6h55.39s11.82,2.31,11.82,23.1V215.45s.72,17.66-12.37,17.66c-10.61,0-54.84.45-54.84.45s-3.76-8.09-.29-15.89h45.58s7,2,7-13V88.84s-.29-10.16-5.2-10.16H159.67S156.2,73.55,159.38,65.6Z" />
          <path className="mug-7" d="M161.07,66.31s-4.86,6,0,11.77C161.07,78.08,159.68,70.52,161.07,66.31Z" />
          <path className="mug-7" d="M161.55,219.18s-5.47,6.7,0,13.26C161.55,232.44,160,223.92,161.55,219.18Z" />
          <path className="mug-8" d="M162.56,66.48h49.62s13.22,2.57,13.22,18.71V215.45h-6.18V85.71S218.7,72,209.09,72H162.73S160.57,69.8,162.56,66.48Z" />
          <path className="mug-7" d="M163,226.74h50.79s5.76-.66,5.76-8.74h5.31s1.11,14.28-14.06,14.28H163A6.89,6.89,0,0,1,163,226.74Z" />
        </g>
      </g>
    </svg>
  );
